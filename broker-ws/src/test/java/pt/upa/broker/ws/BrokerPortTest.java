...
public class BrokerPortTest {
	...
	void testMockTransporterServer(
		...
		// declarations
		 new Expectations() {{
	      ...
	      //TESTS
	      BrokerPort bp = new BrokerPort("placeHolderUrl","placeHolderUrl", false);
	...
	@Test
	public <P extends TransporterPortType & BindingProvider, B extends BrokerPortType & BindingProvider>
	void testRequestTransportInvalidPriceFault_Exception(
        ...
        @Mocked final BrokerService ser,
        @Mocked	final B brokerPort,
		@Mocked final Map<String, Object> requestContext)
		...
		j1.setCompanyName("T1");
		 new Expectations() {{
	            ...
	            new BrokerService(); minTimes=0;
	            ser.getBrokerPort(); result = brokerPort; minTimes=0;
	            brokerPort.getRequestContext(); result = requestContext; minTimes=0;
	            requestContext.put(anyString, anyString); minTimes=0;
	            brokerPort.updateTransports((TransportView)any); minTimes=0;
	            brokerPort.updateClearTransports(); minTimes=0;
	      }};
	      BrokerPort bp = new BrokerPort("placeholderURL","placeholderURL",false);
	...
	void testRequestUnknownLocationFault_Exception(
        ...
        @Mocked final BrokerService ser,
        @Mocked	final B brokerPort,
		@Mocked final Map<String, Object> requestContext) // P and B extend the above types
        throws Exception {
		// declarations
		final JobView j1 = new JobView();
		j1.setJobPrice(2);
	...
	@Test
	public  <B extends BrokerPortType & BindingProvider>
