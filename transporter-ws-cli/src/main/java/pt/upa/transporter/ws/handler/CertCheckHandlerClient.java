...
public class CertCheckHandlerClient implements SOAPHandler<SOAPMessageContext> {
	...
	public boolean handleMessage(SOAPMessageContext smc) {
		...
		if (outbound) {
			...
			if (certMap.get(ClientHandler.RESPONSE_PROPERTY_ORGANIZATION)!=null){
			...
			try {
				...
				CAcli = new CAClient(uddi.lookup(ClientHandler.RESPONSE_PROPERTY_ORGANIZATION));
			...
			byte[] result = CAcli.getCertificate(ClientHandler.RESPONSE_PROPERTY_ORGANIZATION);
