...
public class ClientHandler implements SOAPHandler<SOAPMessageContext> {
	...
	public static String REQUEST_PROPERTY_ORGANIZATION="";
	public static String RESPONSE_PROPERTY_ORGANIZATION=""; // should hold name of the current organization, for private own certificate path
	...
	public boolean handleMessage(SOAPMessageContext smc) {
		...
		if (outbound) {
			...
			try {
				...
				cert=CertCheckHandlerClient.certMap.get(REQUEST_PROPERTY_ORGANIZATION); // static map
				if (cert == null) {
